...
\begin{figure}[!htbp]\captionsetup{justification=centering}
  \centering
  \includegraphics[page=4,trim=2.5cm 8cm 2.25cm 4cm,clip]{../blc_note}
...
%-------------------------------------------------------------------------------
\section{Changes to Local Slope Calculation for Fixed Point}
\label{sec:mxlnew}
The local X slope is expressed  in \cite{blcnote} as:
\begin{equation}
...
\clearpage
\section{Biases in the $\phi$ Calculation}
\label{sec:phishape}
While the $\theta$ and $\Delta\theta$ distributions have a mostly Gaussian shape, the $\phi$ resolution distribution has a markedly non-Gaussian shape.  In order to verify the algorithm was performing correctly, all of the algorithm slope inputs were verified to match up to their truth-level values (calculated using truth-level angles).  Some such plots are shown in Figure \ref{fig:slopediag}, and, as can be seen from the figure, all input quantities have some $\eta$ dependence. 

\begin{figure}[!htbp]\captionsetup{justification=centering}
  \begin{center}
    \begin{subfigure}{0.32\textwidth}\caption{$m_x$}\includegraphics[width=\textwidth]{./figures/nominal/mmt_h00009_ctx3_ctuv3_uverr00035_setxxuvuvxx_ql1_qdlm1_qbg0_qt1_NOM_NOM_Pt100GeVdigintuple_20151111_mx_res_v_eta_fit}\end{subfigure}
    \begin{subfigure}{0.32\textwidth}\caption{$m_y$, $M_X^{global}$}\includegraphics[width=\textwidth]{./figures/nominal/mmt_h00009_ctx3_ctuv3_uverr00035_setxxuvuvxx_ql1_qdlm1_qbg0_qt1_NOM_NOM_Pt100GeVdigintuple_20151111_my_res_v_eta_fit}\end{subfigure}
    \begin{subfigure}{0.32\textwidth}\caption{$M_X^{local}$}\includegraphics[width=\textwidth]{./figures/nominal/mmt_h00009_ctx3_ctuv3_uverr00035_setxxuvuvxx_ql1_qdlm1_qbg0_qt1_NOM_NOM_Pt100GeVdigintuple_20151111_mXl_res_v_eta_fit}\end{subfigure}
  \end{center}
  \caption{\label{fig:slopediag} The mean of the residuals (fit value less truth value) of algorithm input slopes as a function of $\eta$.  Note that the discontinuity in all three plots is a feature of the fact that each plane is divided into two stations in $\eta$, the positions of which are configured independently.  Error bars are the rms in each bin.}
\end{figure}

This dependence is limited for both $M_X^{global}$ and $M_X^{local}$ but is noticeable for $m_x$, the slope corresponding to the horizontal coordinate used in fit angle calculations.  This quantity depends heavily on information from hits in the stereo planes.  The geometry of detector setup used in this simulation explains both the $\eta$ dependence of all the quantities in Figure \ref{fig:slopediag} and the stronger dependence for $m_x$ in particular.  A cartoon of a muon track moving through an octuplet in the NSW with its resulting ionization is shown in Figure \ref{fig:mutrack}.

\begin{figure}[!htbp]\captionsetup{justification=centering}
  \begin{center}
    \includegraphics[width=0.8\textwidth]{./figures/phi_bias_cartoon}
  \end{center}
  \caption{\label{fig:mutrack} A cartoon of a muon (purple) passing through the NSW.  Gaseous regions are shown in gray, horizontal plane strips shown in black, U (V) stereo plane strips shown in blue (green), and ionization in red.}
\end{figure}

As the figure shows, the geometry is such that hits in stereo U (V) planes tend to be biased downwards (upwards), while biases among the horizontal hits will tend to cancel.  The size of this effect depends on the slope of the track and, hence, on $\eta$.  This $\eta$ dependent bias can be seen in Figure \ref{fig:slopediag}.  Recalling Equation \ref{eqn:big3}, $\phi$ depends most heavily on the stereo strip information, while $\theta$ and $\Delta\theta$ depend much more heavily on the horizontal strip information.  This can be seen in Figure \ref{fig:resveta}, where the relative shift in $\theta$ and $\Delta\theta$ is similar to that of the two $M_X$ slopes in Figure \ref{fig:slopediag}, and that of $\phi$ is similar to $m_x$.
\begin{figure}[!htbp]\captionsetup{justification=centering}
  \begin{center}
    \begin{subfigure}{0.32\textwidth}\caption{$\phi$}\includegraphics[width=\textwidth]{./figures/nominal/mmt_h00009_ctx3_ctuv3_uverr00035_setxxuvuvxx_ql1_qdlm1_qbg0_qt1_NOM_NOM_Pt100GeVdigintuple_20151111_phi_res_v_eta_fit}\end{subfigure}
    \begin{subfigure}{0.32\textwidth}\caption{$\theta$}\includegraphics[width=\textwidth]{./figures/nominal/mmt_h00009_ctx3_ctuv3_uverr00035_setxxuvuvxx_ql1_qdlm1_qbg0_qt1_NOM_NOM_Pt100GeVdigintuple_20151111_theta_res_v_eta_fit}\end{subfigure}
    \begin{subfigure}{0.32\textwidth}\caption{$\Delta\theta$}\includegraphics[width=\textwidth]{./figures/nominal/mmt_h00009_ctx3_ctuv3_uverr00035_setxxuvuvxx_ql1_qdlm1_qbg0_qt1_NOM_NOM_Pt100GeVdigintuple_20151111_dtheta_res_v_eta_fit}\end{subfigure}
  \end{center}
  \caption{\label{fig:resveta} The resolutions (fit value less truth value) of algorithm output angles as a function of $\eta$.  Note that the discontinuity in all three plots results from the fact that each plane is divided into two stations in $\eta$, the positions of which are configured independently.  Error bars are the rms in each bin.}
\end{figure}

As to the overall accuracy of the $\phi$ calculation given the non-trivial overall bias of about 0.5 mrad, geometric parameters of the wedge (not properly defined in the software release) were tuned so that biases of input reconstructed means truth slope distributions were centered at zero.  Example distributions of such quantities can be seen in Figure \ref{fig:slopebias}.  The size of the bias can be attributed to the large smear that arises from the larger station at higher $\eta$, which causes the features in Figures \ref{fig:slopediag} (a), \ref{fig:resveta} (a), and ultimately the overall shape in the $\phi$ residual distribution.
\begin{figure}[!htbp]\captionsetup{justification=centering}
  \begin{center}
  \begin{subfigure}{0.3\textwidth}\caption{$M_{X,1}$}\includegraphics[width=\textwidth]{figures/nominal/mmt_h00009_ctx3_ctuv3_uverr00035_setxxuvuvxx_ql1_qdlm1_qbg0_qt1_NOM_NOM_Pt100GeVdigintuple_20151111_res_mx1_etaall}\end{subfigure}
  \begin{subfigure}{0.3\textwidth}\caption{$M_{U,0}$}\includegraphics[width=\textwidth]{figures/nominal/mmt_h00009_ctx3_ctuv3_uverr00035_setxxuvuvxx_ql1_qdlm1_qbg0_qt1_NOM_NOM_Pt100GeVdigintuple_20151111_res_mu0_etaall}\end{subfigure}
  \begin{subfigure}{0.3\textwidth}\caption{$M_{V,0}$}\includegraphics[width=\textwidth]{figures/nominal/mmt_h00009_ctx3_ctuv3_uverr00035_setxxuvuvxx_ql1_qdlm1_qbg0_qt1_NOM_NOM_Pt100GeVdigintuple_20151111_res_mv0_etaall}\end{subfigure}
  \caption{\label{fig:slopebias}Example calibration plots for input slopes---in these cases resolutions for the X (a), U (b), and V (c) planes in a row in the first quadruplet.}
  \end{center}
\end{figure}

\clearpage

\section{Background Rates Normalization}
\label{sec:bg}
...
\clearpage
\section{Generic Calculation of Misalignment}
\label{sec:genmisal}
...
\clearpage
\section{All Misalignment/Correction Plots}
\label{sec:allplots}
All plots for misalignment and all relevant misalignment correction types for fit quantities $\theta$, $\phi$, $\Delta\theta$ bias means and standard deviations for each of the six misalignment cases studied $\Delta s$ (Figure \ref{fig:dtsall}), $\Delta z$ (Figure \ref{fig:dtzall}), $\Delta t$ (Figure \ref{fig:dttall}), $\gamma_s$ (Figure \ref{fig:drsall}), $\beta_s$ (Figure \ref{fig:drzall}), and $\alpha_t$ (Figure \ref{fig:drtall})

\begin{figure}[!htbp]\captionsetup{justification=centering}
  \centering
  \begin{subfigure}{0.32000\textwidth}\caption{$\theta$ bias/mis}\includegraphics[width=\textwidth]{./figures/misal/mean_res_theta_tfit_misal_dts_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_abs_20151111}\end{subfigure}
  \begin{subfigure}{0.32000\textwidth}\caption{$\phi$ bias/mis}\includegraphics[width=\textwidth]{./figures/misal/mean_res_phi_tfit_misal_dts_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_abs_20151111}\end{subfigure}
  \begin{subfigure}{0.32000\textwidth}\caption{$\Delta\theta$ bias/mis}\includegraphics[width=\textwidth]{./figures/misal/mean_res_dtheta_tfit_misal_dts_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_abs_20151111}\end{subfigure}
  \begin{subfigure}{0.32000\textwidth}\caption{$\theta$ rms/mis}\includegraphics[width=\textwidth]{./figures/misal/sigma_res_theta_tfit_misal_dts_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_rel_20151111}\end{subfigure}
  \begin{subfigure}{0.32000\textwidth}\caption{$\phi$ rms/mis}\includegraphics[width=\textwidth]{./figures/misal/sigma_res_phi_tfit_misal_dts_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_rel_20151111}\end{subfigure}
  \begin{subfigure}{0.32000\textwidth}\caption{$\Delta\theta$ rms/mis}\includegraphics[width=\textwidth]{./figures/misal/sigma_res_dtheta_tfit_misal_dts_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_rel_20151111}\end{subfigure}
  \caption{\label{fig:dtsall}Biases [rms] of fit quantities $\theta$ (a) [(d)], $\phi$ (b) [(e)], and $\Delta\theta$ (c) [(f)] as a function of $\Delta s$.}
\end{figure}

\begin{figure}[!htbp]\captionsetup{justification=centering}
  \centering
  \begin{subfigure}{0.320000\textwidth}\caption{$\theta$ bias/mis}\includegraphics[width=\textwidth]{./figures/misal/mean_res_theta_tfit_misal_dtz_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_abs_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\phi$ bias/mis}\includegraphics[width=\textwidth]{./figures/misal/mean_res_phi_tfit_misal_dtz_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_abs_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\Delta\theta$ bias/mis}\includegraphics[width=\textwidth]{./figures/misal/mean_res_dtheta_tfit_misal_dtz_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_abs_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\theta$ rms/mis}\includegraphics[width=\textwidth]{./figures/misal/sigma_res_theta_tfit_misal_dtz_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_rel_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\phi$ rms/mis}\includegraphics[width=\textwidth]{./figures/misal/sigma_res_phi_tfit_misal_dtz_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_rel_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\Delta\theta$ rms/mis}\includegraphics[width=\textwidth]{./figures/misal/sigma_res_dtheta_tfit_misal_dtz_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_rel_20151111}\end{subfigure}
  \caption{\label{fig:dtzall}Biases [rms] of fit quantities $\theta$ (a) [(d)], $\phi$ (b) [(e)], and $\Delta\theta$ (c) [(f)] as a function of $\Delta z$.}
\end{figure}

\begin{figure}[!htbp]\captionsetup{justification=centering}
  \centering
  \begin{subfigure}{0.320000\textwidth}\caption{$\theta$ bias/mis}\includegraphics[width=\textwidth]{./figures/misal/mean_res_theta_tfit_misal_dtt_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_abs_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\phi$ bias/mis}\includegraphics[width=\textwidth]{./figures/misal/mean_res_phi_tfit_misal_dtt_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_abs_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\Delta\theta$ bias/mis}\includegraphics[width=\textwidth]{./figures/misal/mean_res_dtheta_tfit_misal_dtt_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_abs_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\theta$ rms/mis}\includegraphics[width=\textwidth]{./figures/misal/sigma_res_theta_tfit_misal_dtt_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_rel_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\phi$ rms/mis}\includegraphics[width=\textwidth]{./figures/misal/sigma_res_phi_tfit_misal_dtt_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_rel_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\Delta\theta$ rms/mis}\includegraphics[width=\textwidth]{./figures/misal/sigma_res_dtheta_tfit_misal_dtt_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_rel_20151111}\end{subfigure}
  \caption{\label{fig:dttall}Biases [rms] of fit quantities $\theta$ (a) [(d)], $\phi$ (b) [(e)], and $\Delta\theta$ (c) [(f)] as a function of $\Delta t$.}
\end{figure}

\begin{figure}[!htbp]\captionsetup{justification=centering}
  \centering
  \begin{subfigure}{0.320000\textwidth}\caption{$\theta$ bias/mis}\includegraphics[width=\textwidth]{./figures/misal/mean_res_theta_tfit_misal_drs_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_abs_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\phi$ bias/mis}\includegraphics[width=\textwidth]{./figures/misal/mean_res_phi_tfit_misal_drs_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_abs_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\Delta\theta$ bias/mis}\includegraphics[width=\textwidth]{./figures/misal/mean_res_dtheta_tfit_misal_drs_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_abs_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\theta$ rms/mis}\includegraphics[width=\textwidth]{./figures/misal/sigma_res_theta_tfit_misal_drs_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_rel_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\phi$ rms/mis}\includegraphics[width=\textwidth]{./figures/misal/sigma_res_phi_tfit_misal_drs_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_rel_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\Delta\theta$ rms/mis}\includegraphics[width=\textwidth]{./figures/misal/sigma_res_dtheta_tfit_misal_drs_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_rel_20151111}\end{subfigure}
  \caption{\label{fig:drsall}Biases [rms] of fit quantities $\theta$ (a) [(d)], $\phi$ (b) [(e)], and $\Delta\theta$ (c) [(f)] as a function of $\gamma_s$.}
\end{figure}

\begin{figure}[!htbp]\captionsetup{justification=centering}
  \centering
  \begin{subfigure}{0.320000\textwidth}\caption{$\theta$ bias/mis}\includegraphics[width=\textwidth]{./figures/misal/mean_res_theta_tfit_misal_drz_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_abs_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\phi$ bias/mis}\includegraphics[width=\textwidth]{./figures/misal/mean_res_phi_tfit_misal_drz_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_abs_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\Delta\theta$ bias/mis}\includegraphics[width=\textwidth]{./figures/misal/mean_res_dtheta_tfit_misal_drz_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_abs_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\theta$ rms/mis}\includegraphics[width=\textwidth]{./figures/misal/sigma_res_theta_tfit_misal_drz_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_rel_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\phi$ rms/mis}\includegraphics[width=\textwidth]{./figures/misal/sigma_res_phi_tfit_misal_drz_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_rel_20151111}\end{subfigure}
  \begin{subfigure}{0.320000\textwidth}\caption{$\Delta\theta$ rms/mis}\includegraphics[width=\textwidth]{./figures/misal/sigma_res_dtheta_tfit_misal_drz_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_rel_20151111}\end{subfigure}
  \caption{\label{fig:drzall}Biases [rms] of fit quantities $\theta$ (a) [(d)], $\phi$ (b) [(e)], and $\Delta\theta$ (c) [(f)] as a function of $\beta_z$.}
\end{figure}

\begin{figure}[!htbp]\captionsetup{justification=centering}
  \centering
  \begin{subfigure}{0.32000\textwidth}\caption{$\theta$ bias/mis}\includegraphics[width=\textwidth]{./figures/misal/mean_res_theta_tfit_misal_drt_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_abs_20151111}\end{subfigure}
  \begin{subfigure}{0.32000\textwidth}\caption{$\phi$ bias/mis}\includegraphics[width=\textwidth]{./figures/misal/mean_res_phi_tfit_misal_drt_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_abs_20151111}\end{subfigure}
  \begin{subfigure}{0.32000\textwidth}\caption{$\Delta\theta$ bias/mis}\includegraphics[width=\textwidth]{./figures/misal/mean_res_dtheta_tfit_misal_drt_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_abs_20151111}\end{subfigure}
  \begin{subfigure}{0.32000\textwidth}\caption{$\theta$ rms/mis}\includegraphics[width=\textwidth]{./figures/misal/sigma_res_theta_tfit_misal_drt_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_rel_20151111}\end{subfigure}
  \begin{subfigure}{0.32000\textwidth}\caption{$\phi$ rms/mis}\includegraphics[width=\textwidth]{./figures/misal/sigma_res_phi_tfit_misal_drt_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_rel_20151111}\end{subfigure}
  \begin{subfigure}{0.32000\textwidth}\caption{$\Delta\theta$ rms/mis}\includegraphics[width=\textwidth]{./figures/misal/sigma_res_dtheta_tfit_misal_drt_stk-qcor_pt100GeV_etaall_qt1_bg0_ctx3_ctuv3_setxxuvuvxx_ql1_qdlm1_rel_20151111}\end{subfigure}
  \caption{\label{fig:drtall}Biases [rms] of fit quantities $\theta$ (a) [(d)], $\phi$ (b) [(e)], and $\Delta\theta$ (c) [(f)] as a function of $\alpha_t$}
\end{figure}
\begin{comment}
\clearpage
\printbibliography
...
%The Level-1 trigger algorithm for micromegas (MM) segment reconstruction in the New Small Wheel (NSW) is described in detail in \cite{blcnote}.  The general concept of the algorithm is that the detection region for a wedge (two quadruplets of MM planes) can be divided up into regions in $\eta$.  Pointing these regions back to the interaction point (IP) forms a number of so-called ``slope-roads'' through which a segment can pass.  Using the slopes of hits and the geometry of the multiplets, where the strips in two of the four planes are exactly horizontal and the other two are rotated by 1.5 degrees in opposite directions, allows one to do fits in slope-roads with a number of hits passing some threshold requirement.  The hit information corresponds to slopes. 


mmt_h00009_ctx2_ctuv1_uverr00035_setxxuvuvxx_ql1_qdlm1_qbg0_qt1_NOM_NOM_Pt100GeVdigintuple_20151111_res_theta_etaall}\end{subfigure}
  \begin{subfigure}{0.4\textwidth}\caption{$\theta$ 4X+4UV}\includegraphics[width=\textwidth]{figures/nominal/mmt_h00009_ctx3_ctuv3_uverr00035_setxxuvuvxx_ql1_qdlm1_qbg0_qt1_NOM_NOM_Pt100GeVdigintuple_20151111_res_theta_etaall}\end{subfigure}
  \begin{subfigure}{0.4\textwidth}\caption{$\phi$ 2X+1UV}\includegraphics[width=\textwidth]{figures/nominal/mmt_h00009_ctx2_ctuv1_uverr00035_setxxuvuvxx_ql1_qdlm1_qbg0_qt1_NOM_NOM_Pt100GeVdigintuple_20151111_res_phi_etaall}\end{subfigure}
  \begin{subfigure}{0.4\textwidth}\caption{$\phi$ 4X+4UV}\includegraphics[width=\textwidth]{figures/nominal/mmt_h00009_ctx3_ctuv3_uverr00035_setxxuvuvxx_ql1_qdlm1_qbg0_qt1_NOM_NOM_Pt100GeVdigintuple_20151111_res_phi_etaall}\end{subfigure}
  \begin{subfigure}{0.4\textwidth}\caption{$\Delta\theta$ 2X+1UV}\includegraphics[width=\textwidth]{figures/nominal/mmt_h00009_ctx2_ctuv1_uverr00035_setxxuvuvxx_ql1_qdlm1_qbg0_qt1_NOM_NOM_Pt100GeVdigintuple_20151111_res_dtheta_etaall}\end{subfigure}
  \begin{subfigure}{0.4\textwidth}\caption{$\Delta\theta$ 4X+4UV}\includegraphics[width=\textwidth]{figures/nominal/mmt_h00009_ctx3_ctuv3_uverr00035_setxxuvuvxx_ql1_qdlm1_qbg0_qt1_NOM_NOM_Pt100GeVdigintuple_20151111_res_dtheta_etaall}\end{subfigure}

% LocalWords:  NSW TP MMTP BCs str iz iy GeoModel multiplet xxuvuvxx tru rms BG
% LocalWords:  ively alg reco VMM BCID AMDB LUT runtime const sim misal lM dr
% LocalWords:  Mathematica quant pos ccc ds dt mis mmt ctx ctuv uverr ql qdlm
% LocalWords:  setxxuvuvxx qbg NOM GeVdigintuple etaall pdf
\end{comment}

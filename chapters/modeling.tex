...
\hline 
\end{tabular} 
\caption{ \label{tab:ttbarSysSummary1} Effect of modelling systematics on \ttbar\ normalization in the 0 and 1-lepton analysis region.} 
\end{center} 
\end{table} 
...
\hline 
\end{tabular} 
\caption{ \label{tab:ttbarSysSummary2} Effect of modelling systematics on \ttbar\ normalization in the 2lepton regions. The \texttt{SysTTbarPTV\_L2\_L2} systematic is implemented as a shape systematic over the full VpT>75\,GeV range, and as a result has different acceptance effects in the low and high VpT regions.} 
\end{center} 
\end{table} 

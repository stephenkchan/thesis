...
\section{Postfit Plots and Fit Validation}
Plots for the postfit BDT output in the most sensitive signal region, the 2 jet, high \ptv\, region are given in Figure \ref{fig:bdtpostfit}; postfit agreement is fairly good.  Discussion of fit model validations are deferred to the appendices.  The validation $VZ$ fits and its results are described in Appendix \ref{app:vz}.  $VH$ fit validation, including full postfit plots and a fit pull comparison, is provided in Appendix \ref{app:postfit}.

\begin{figure}[!htbp]\captionsetup{justification=centering}
    \centering
\begin{subfigure}[t]{0.32000\textwidth}\centering\includegraphics[width=\textwidth]{figures/RFLI_std-kf_v04.v04_fullRes_RFLI_std-kf_v04.v04/Region_BMin150_J2_T2_L2_Y2015_distmva_DSR_GlobalFit_unconditionnal_mu1}}\caption{Standard}\end{subfigure}
\begin{subfigure}[t]{0.32000\textwidth}\centering\includegraphics[width=\textwidth]{figures/RFLI_li-met_v04.v04_fullRes_RFLI_li-met_v04.v04/Region_BMin150_J2_T2_L2_Y2015_distmva_DSR_GlobalFit_unconditionnal_mu1}}\caption{LI}\end{subfigure}
\begin{subfigure}[t]{0.32000\textwidth}\centering\includegraphics[width=\textwidth]{figures/RFLI_rf-sel_v04.v04_fullRes_RFLI_rf-sel_v04.v04/Region_BMin150_J2_T2_L2_Y2015_distmva_DSR_GlobalFit_unconditionnal_mu1}}\caption{RF}\end{subfigure}
  \caption{Postfit $BDT_{VH}$ plots in the 2 jet, high \ptv\, signal region for the standard, LI, and RF variable sets.}
  \label{fig:bdtpostfit}
\end{figure}

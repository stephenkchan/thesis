...
\begin{figure}[!htbp]\captionsetup{justification=centering}
  \centering
  \includegraphics[width=0.45\linewidth]{figures/comb/r1_combData-r2_obsData-jes_partial-eps02_rank_job100of100_Run1Run2Comb_r1_combData-r2_obsData-jes_partial-eps02_pulls_125.pdf}
...
\begin{figure}[!htbp]\captionsetup{justification=centering}
  \begin{center}
  \includegraphics[width=0.75\linewidth]{figures/comb/Plot_mu_eps02_WHZH.pdf}
...
\begin{figure}[!htbp]\captionsetup{justification=centering}
  \begin{center}
  \includegraphics[width=0.75\linewidth]{figures/comb/Plot_mu_eps02_channels.pdf}
...
\begin{figure}[!htbp]\captionsetup{justification=centering}
  \begin{center}
  \includegraphics[width=0.75\linewidth]{figures/comb/Plot_mu_eps02_7813.pdf}
...
\begin{figure}[!htbp]\captionsetup{justification=centering}
  \begin{center}
  \includegraphics[width=0.75\linewidth]{figures/comb/Plot_mu_eps02_r1r2channels.pdf}
...
\begin{figure}[!htbp]\captionsetup{justification=centering}
  \begin{center}
  \includegraphics[width=0.75\linewidth]{figures/comb/Plot_mu_eps02_r1r2.pdf}
...
\begin{figure}[htbp]
  \centering
  \begin{tabular}{cccc}
\begin{subfigure}[t]{0.24\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/run1_maps/Coeffs_2DHisto_original.pdf}}\caption{}\end{subfigure}
\begin{subfigure}[t]{0.24\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/run1_maps/Coeffs_2DHisto_scaled.pdf}}\caption{}\end{subfigure}
\begin{subfigure}[t]{0.24\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/run2_maps/Coeffs_2DHisto_original.pdf}}\caption{}\end{subfigure}
\begin{subfigure}[t]{0.24\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/run2_maps/Coeffs_2DHisto_scaled.pdf}}\caption{}\end{subfigure}
    \end{tabular}
...
Unfolding was found to have very little effect on both expected sensitivites and errors, as can be seen in Tables~\ref{tab:unfold_jes_sensitivities} and~\ref{tab:unfold_jes_breakdowns}.
\begin{table}[!htbp]
...
\begin{comment}
It was also found that fit quantities of interest were similarly indifferent to the use of either the strong or weak JES correlation schemes, as shown in Tables~\ref{tab:sw_jes_sensitivities} and~\ref{tab:sw_jes_breakdowns}.
...
\begin{figure}[!htbp]
  \centering
\begin{subfigure}[t]{0.45000\textwidth}\centering\includegraphics[width=\textwidth]{x_combData-jesu1_rank_job100of100_Run1Run2Comb_x_combData-jesu1_pulls_125.pdf}}\caption{R1 Unfold}\end{subfigure}
\begin{subfigure}[t]{0.45000\textwidth}\centering\includegraphics[width=\textwidth]{r1_combData-613r1_rank_job100of100_Run1Run2Comb_r1_combData-613r1_pulls_125.pdf}}\caption{R1 Eff}\end{subfigure}
...
\begin{figure}[!htbp]
  \centering
\begin{subfigure}[t]{0.45000\textwidth}\centering\includegraphics[width=\textwidth]{test_obsData-jesu2_rank_Run1Run2Comb_test_obsData-jesu2_pulls_125.pdf}}\caption{R1 Unfold}\end{subfigure}
\begin{subfigure}[t]{0.45000\textwidth}\centering\includegraphics[width=\textwidth]{r2_obsData-907r2_rank_Run1Run2Comb_r2_obsData-907r2_pulls_125.pdf}}\caption{R1 Eff}\end{subfigure}
...
\begin{figure}[!htbp]
  \centering
\begin{subfigure}[t]{0.45\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/r1_asimovData_cnd1_0-51-r2_asimovData_cnd1_1-jesu_partial-509alpha_rank_job100of100_Run1Run2Comb_r1_asimovData_cnd1_0-51-r2_asimovData_cnd1_1-jesu_partial-509alpha_pulls_125.pdf}}\caption{Weak Unfold}\end{subfigure}
\begin{subfigure}[t]{0.45\linewidth]{figures/comb/r1_asimovData_cnd1_0-51-r2_asimovData_cnd1_1-jes_partial-509alpha_rank_job100of100_Run1Run2Comb_r1_asimovData_cnd1_0-51-r2_asimovData_cnd1_1-jes_partial-509alpha_pulls_125.pdf}} \\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/r1_asimovData_cnd1_0-51-r2_asimovData_cnd1_1-jes_partial-509alpha_rank_job100of100_Run1Run2Comb_r1_asimovData_cnd1_0-51-r2_asimovData_cnd1_1-jes_partial-509alpha_pulls_125.pdf}}\caption{Weak Eff}\end{subfigure}
\begin{subfigure}[t]{0.45\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/r1_combData-r2_obsData-jesu_partial-eps02_rank_job100of100_Run1Run2Comb_r1_combData-r2_obsData-jesu_partial-eps02_pulls_125.pdf}}\caption{Unfolded JES}\end{subfigure}
\begin{subfigure}[t]{0.45\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/r1_combData-r2_obsData-jes_partial-eps02_rank_job100of100_Run1Run2Comb_r1_combData-r2_obsData-jes_partial-eps02_pulls_125.pdf}}\caption{Effective JES}\end{subfigure}
  \caption{Ranks for the effective and unfolded JES NP Run1+Run2 combined workspaces.}
    \label{fig:Ranks:jesuc}
\end{figure}


As a result of these studies, the weak JES correlation scheme with uncorrelated effective JES NP's has been chosen as the treatment of JES in the Run 1 + Run 2 combined fit.


\subsubsection{JES Pull Comparisons}

\begin{figure}[!htbp]
\centering
\begin{subfigure}[t]{0.67\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/pullcomp-jesu/NP_Jet.pdf}}\caption{Jet}\end{subfigure}
...
\begin{figure}[!htbp]
\centering
\begin{subfigure}[t]{0.67\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/pullcomp-jesu/NP_JetMatched.pdf}}\caption{JetMatched}\end{subfigure}
...
\begin{figure}[!htbp]
\centering
\begin{subfigure}[t]{0.67\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/pullcomp-jesu/NP_JetEff.pdf}}\caption{JetEff}\end{subfigure}
...
\begin{figure}[!htbp]
\centering
\begin{subfigure}[t]{\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/pullcomp-jesu/NP_JetUnfold.pdf}}\caption{JetUnfold}\end{subfigure}
...
\begin{figure}[!htbp]
\center
  \label{fig:SingleTopRun11of2}
\begin{subfigure}[t]{0.225\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_8TeV/f_SysTopMbb.pdf}}\caption{SysTopMbb}\end{subfigure}
\begin{subfigure}[t]{0.225\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_8TeV/f_SysWtPt2jHighPt.pdf}}\caption{SysWtPt2jHighPt}\end{subfigure}
\begin{subfigure}[t]{0.225\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_8TeV/f_SysWtPt2jLowPt.pdf}}\caption{SysWtPt2jLowPt}\end{subfigure}
\begin{subfigure}[t]{0.225\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_8TeV/f_SysWtPt3jHighPt.pdf}}\caption{SysWtPt3jHighPt}\end{subfigure}
  \caption{Single Top, Run1 (1 of 2) }
\end{figure}

\begin{figure}[!htbp]
\center
  \label{fig:SingleTopRun12of2}
\begin{subfigure}[t]{0.45\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_8TeV/f_SysWtPt3jLowPt.pdf}}\caption{JetMatcSysWtPt3jLowPthed}\end{subfigure}
  \caption{Single Top, Run1 (2 of 2) }
\end{figure}

\begin{figure}[!htbp]
\center
  \label{fig:SingleTopRun21of1}
\begin{subfigure}[t]{0.3\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/f_SysStopWtMBB.pdf}}\caption{SysStopWtMBB}\end{subfigure}
\begin{subfigure}[t]{0.3\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/f_SysStopWtPTV.pdf}}\caption{SysStopWtPTV}\end{subfigure}
\begin{subfigure}[t]{0.3\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/f_SysStoptMBB.pdf}}\caption{SysStoptMBB}\end{subfigure}
  \caption{Single Top, Run2 (1 of 1) }
\end{figure}

\begin{figure}[!htbp]
\center
  \label{fig:V+jetsMbbRun11of1}
\begin{subfigure}[t]{0.3\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_8TeV/f_SysWMbb.pdf}}\caption{SysWMbb}\end{subfigure}
\begin{subfigure}[t]{0.3\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_8TeV/f_SysWbbPtW.pdf}}\caption{SysWbbPtW}\end{subfigure}
\begin{subfigure}[t]{0.3\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_8TeV/f_SysZMbb.pdf}}\caption{SysZMbb}\end{subfigure}
  \caption{V+jets Mbb, Run1 (1 of 1) }
\end{figure}

\begin{figure}[!htbp]
\center
  \label{fig:V+jetsMbbRun21of1}
\begin{subfigure}[t]{0.3\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/f_SysWMbb.pdf}}\caption{SysWMbb}\end{subfigure}
\begin{subfigure}[t]{0.3\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/f_SysWPtV.pdf}}\caption{SysWPtV}\end{subfigure}
\begin{subfigure}[t]{0.3\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/f_SysZMbb.pdf}}\caption{SysZMbb}\end{subfigure}
  \caption{V+jets Mbb, Run2 (1 of 1) }
\end{figure}

\begin{figure}[!htbp]
\center
  \label{fig:DibosonRun11of1}
\begin{subfigure}[t]{0.45\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_8TeV/f_SysWZMbb.pdf}}\caption{SysWZMbb}\end{subfigure}
\begin{subfigure}[t]{0.45\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_8TeV/f_SysZZMbb.pdf}}\caption{SysZZMbb}\end{subfigure}
  \caption{Diboson, Run1 (1 of 1) }
\end{figure}

\begin{figure}[!htbp]
\center
  \label{fig:DibosonRun21of2}
\begin{subfigure}[t]{0.225\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/mBB__WZlvqq_PS_PS_fit.pdf}}\caption{mBBWZlvqqPSPS}\end{subfigure}
\begin{subfigure}[t]{0.225\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/mBB__WZlvqq_PS_Sherpa_fit.pdf}}\caption{mBBWZlvqqPSSherpa}\end{subfigure}
\begin{subfigure}[t]{0.225\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/mBB__ZZqqll_PS_PS_fit.pdf}}\caption{mBBZZqqllPSPS}\end{subfigure}
\begin{subfigure}[t]{0.225\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/mBB__ZZqqll_PS_Sherpa_fit.pdf}}\caption{mBBZZqqllPSSherpa}\end{subfigure}
  \caption{Diboson, Run2 (1 of 2) }
\end{figure}

\begin{figure}[!htbp]
\center
  \label{fig:DibosonRun22of2}
\begin{subfigure}[t]{0.45\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/mBB__ZZqqvv_PS_PS_fit.pdf}}\caption{mBBZZqqvvPSPS}\end{subfigure}
\begin{subfigure}[t]{0.45\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/mBB__ZZqqvv_PS_Sherpa_fit.pdf}}\caption{mBBZZqqvvPSSherpa}\end{subfigure}
  \caption{Diboson, Run2 (2 of 2) }
\end{figure}

\begin{figure}[!htbp]
\center
  \label{fig:ttbarPtVRun11of1}
\begin{subfigure}[t]{0.45\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_8TeV/f_SysTtbarPtVhpt.pdf}}\caption{SysTtbarPtVhpt}\end{subfigure}
\begin{subfigure}[t]{0.45\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_8TeV/f_SysTtbarPtVlpt.pdf}}\caption{SysTtbarPtVlpt}\end{subfigure}
  \caption{ttbar PtV, Run1 (1 of 1) }
\end{figure}

\begin{figure}[!htbp]
\center
  \label{fig:ttbarPtVRun21of1}
\begin{subfigure}[t]{0.45\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/f_SysTTbarPTV_01lep.pdf}}\caption{SysTTbarPTV01lep}\end{subfigure}
\begin{subfigure}[t]{0.45\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/f_SysTTbarPTV_2lep.pdf}}\caption{SysTTbarPTV2lep}\end{subfigure}
  \caption{ttbar PtV, Run2 (1 of 1) }
\end{figure}

\begin{figure}[!htbp]
\center
  \label{fig:ttbarMBBRun11of1}
\begin{subfigure}[t]{0.225\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_8TeV/f_SysTtbarMBB2jethpt.pdf}}\caption{SysTtbarMBB2jethpt}\end{subfigure}
\begin{subfigure}[t]{0.225\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_8TeV/f_SysTtbarMBB2jetlpt.pdf}}\caption{SysTtbarMBB2jetlpt}\end{subfigure}
\begin{subfigure}[t]{0.225\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_8TeV/f_SysTtbarMBB3jethpt.pdf}}\caption{SysTtbarMBB3jethpt}\end{subfigure}
\begin{subfigure}[t]{0.225\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_8TeV/f_SysTtbarMBB3jetlpt.pdf}}\caption{SysTtbarMBB3jetlpt}\end{subfigure}
  \caption{ttbar MBB, Run1 (1 of 1) }
\end{figure}

\begin{figure}[!htbp]
\center
  \label{fig:ttbarMBBRun21of2}
\begin{subfigure}[t]{0.225\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/f_SysTTbarMBB_01lep.pdf}}\caption{SysTTbarMBB01lep}\end{subfigure}
\begin{subfigure}[t]{0.225\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/f_SysTTbarMBB_0lep.pdf}}\caption{SysTTbarMBB0lep}\end{subfigure}
\begin{subfigure}[t]{0.225\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/f_SysTTbarMBB_1lep.pdf}}\caption{SysTTbarMBB1lep}\end{subfigure}
\begin{subfigure}[t]{0.225\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/f_SysTTbarMBB_2lep.pdf}}\caption{SysTTbarMBB2lep}\end{subfigure}
  \caption{ttbar MBB, Run2 (1 of 2) }
\end{figure}

\begin{figure}[!htbp]
\center
  \label{fig:ttbarMBBRun22of2}
\begin{subfigure}[t]{0.45\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/f_SysTTbarMBB_2lep2jet.pdf}}\caption{SysTTbarMBB2lep2jet}\end{subfigure}
\begin{subfigure}[t]{0.45\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/CS_TwoLep_13TeV/f_SysTTbarMBB_2lep3jet.pdf}}\caption{SysTTbarMBB2lep3jet}\end{subfigure}
  \caption{ttbar MBB, Run2 (2 of 2) }
\end{figure}
...
\begin{figure}[!htbp]
  \centering
\begin{subfigure}[t]{0.32\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/r1_combData-r2_obsData-jes_partial-eps02_rank_job100of100_Run1Run2Comb_r1_combData-r2_obsData-jes_partial-eps02_pulls_125.pdf}}\caption{Comb Eff}\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/r1_combData-r2_obsData-btag-b_partial-eps02_rank_job100of100_Run1Run2Comb_r1_combData-r2_obsData-btag-b_partial-eps02_pulls_125.pdf}}\caption{BTag B0}\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/r1_combData-r2_obsData-btag-nf_partial-eps02_rank_job100of100_Run1Run2Comb_r1_combData-r2_obsData-btag-nf_partial-eps02_pulls_125.pdf}}\caption{B0 8 TeV Not Flipped}\end{subfigure}
...
It is clear from these results that correlating the leading effective Eigen NP associated with $b$'s can have a noticeable effect on final fit results and that the 8 TeV B0 NP is the most important component of a combined B0 NP.  What is less clear is whether there are sufficient grounds for doing so (i.e. does the correspondence of these NP's across years warrant a full correlation).

\begin{figure}[!htbp]
\center
  \label{fig:PullComparisons:btag-b---BTagB0}
\begin{subfigure}[t]{0.67\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/pullcomp-btag-b/NP_BTagB0.eps}}\caption{BTagB0}\end{subfigure}
...
\begin{subfigure}[t]{0.67\textwidth}\centering\includegraphics[width=\textwidth]{figures/comb/pullcomp-btag-b/NP_BTagB.eps}}\caption{BTagB}\end{subfigure}

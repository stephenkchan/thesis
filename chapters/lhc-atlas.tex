...
%JEH: might make reference to the SSC with individual magnets, and that the LHC magnets are more challenging.  In this vein, mention the iron and magnetic circulation that allows for counter-rotating beams.
...
%JEH: might make mention of betatron oscillations creating a beam envelope – maybe too much detail, though
...
% JEH:  also should say that pion production in min bias pp collisions are flat in pseudo rapidity.  I can explain, if you want. 

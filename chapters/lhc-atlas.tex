...
\begin{figure}[!htbp]\captionsetup{justification=centering}
  \centering
  \includegraphics[width=0.75\linewidth]{figures/atlas/CERN-accelerator-complex2013}
...
\begin{figure}[!htbp]\captionsetup{justification=centering}
  \centering
  \includegraphics[width=\linewidth]{figures/atlas/fig_LHC_area_overview}
\end{figure}
...
\begin{figure}[!htbp]\captionsetup{justification=centering}
  \centering
  \includegraphics[width=\linewidth]{figures/atlas/ibl}
\end{figure}
\end{landscape}\clearpage

...
\begin{figure}[!htbp]\captionsetup{justification=centering}
  \centering
  \begin{subfigure}{0.32\textwidth}\includegraphics[width=\textwidth]{./figures/dts}\end{subfigure}
  \begin{subfigure}{0.32\textwidth}\includegraphics[width=\textwidth]{./figures/dtz}\end{subfigure}
  \begin{subfigure}{0.32\textwidth}\includegraphics[width=\textwidth]{./figures/dtt}\end{subfigure}
  \begin{subfigure}{0.32\textwidth}\includegraphics[width=\textwidth]{./figures/drs}\end{subfigure}
  \begin{subfigure}{0.32\textwidth}\includegraphics[width=\textwidth]{./figures/drz}\end{subfigure}
  \begin{subfigure}{0.32\textwidth}\includegraphics[width=\textwidth]{./figures/drt}\end{subfigure}
  \caption{\label{fig:misalscheme}The different misalignment cases as defined in the AMDB manual.}
\end{figure}

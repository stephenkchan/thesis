...
\begin{figure}[!htbp]\captionsetup{justification=centering}
  ...
  \caption{Reconstruction in a nutshell.  You can (not) see the Higgs.}
  \label{fig:recon}
\end{figure}
...
\begin{table}[!htbp]\captionsetup{justification=centering}
\caption{Variables used to train the multivariate discriminant. Starred variables ($b$-tag scores) are not included in current versions of the standard discriminants, but have traditionally been included and most likely will be reintroduced as soon as their accompanying systematics are available.\label{tbl:MVAinputs}}
\begin{center}
